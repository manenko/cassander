...
pub enum LatencyAwareRoutingPolicy {
    ...
    Standard {
        settings: Option<StandardLatencyAwareRoutingPolicySettings>,
    },
}

/// The standard latency-aware routing policy settings.
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct StandardLatencyAwareRoutingPolicySettings {
